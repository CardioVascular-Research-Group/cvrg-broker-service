...
public class QRS_Score {
	public boolean verbose = false;
 	...
 	/** Sex Male = 0; Female = 1 **/
 	public float Sex = 0;  //
 	public float vrate = 51;  //
 	public float arate = 51;  //
 	public float pr = 156;  // 
 	public float qrsd = 88;  //
 	public float qt = 448;  //
 	public float qtc = 412;  //  	
 	public float pax = 76;  //
 	public float qrsax = 55;  //
 	public float tax = 57;  //
 	public float pdur = 114;  //  	
 	
 	public float qrstangle = 53;  //
 	
 	public float pa_aVF = 87;  //
 	public float pa_V1 = 58;  //
 	
	public float qa_I = 43;  //
	public float qa_II = 39;  //
	public float qa_aVL = 39;  //
	public float qa_aVF = 24;  //
	public float qa_V1 = 0; //
	public float qa_V2 = 0;  // 
	public float qa_V3 = 0;  //
	public float qa_V4 = 0;  //
	public float qa_V5 = 29;  //  	
	public float qa_V6 = 83;  //
	
	public float qd_I = 21;  //  	
	public float qd_II = 18;  //
	public float qd_aVL = 26;  // 
	public float qd_aVF = 18;  //
	public float qd_V1 = 0;  //
	public float qd_V2 = 0;  //
	public float qd_V3 = 0;  //
	public float qd_V4 = 0;  //
	public float qd_V5 = 15;  //
	public float qd_V6 = 21;  //

	//									
	public float ra_I = 620;  //  	
	public float ra_II =1181;  //  	
	public float ra_aVL = 87;  //  	
	public float ra_aVF = 898;  //
	public float ra_V1 = 209;  //  	
	public float ra_V2 = 454;  //  	
	public float ra_V3 = 390;  //  	
	public float ra_V4 = 1562;  //
	public float ra_V5 = 2075;  //  	
	public float ra_V6 = 1601;  //

	public float rd_V1 = 25;  //
	public float rd_V2 = 25;  //
	public float rd_V3 = 27;  //

	
	public float sa_I = 0;  //  	
	public float sa_II = 170;  //
	public float sa_aVL = 78;  //
	public float sa_aVF = 185;  //
	public float sa_V1 = 1250;  //
	public float sa_V2 = 2021;  //
	public float sa_V3 = 1250;  //
	public float sa_V4 = 502;  //
	public float sa_V5 = 97;  //
	public float sa_V6 = 0;  //  	
	
	public float rpa_I = 0;  //
	public float rpa_II = 0;  //
	public float rpa_aVL = 122;  //  	
	public float rpa_aVF = 0;  //  	
	public float rpa_V1 = 0;  //
	public float rpa_V2 = 0;  //  	
	public float rpa_V3 = 0;  //  	
	public float rpa_V4 = 0;  //  	
	public float rpa_V5 = 29 ;  //
	...
	public QRS_Score(){
		...
		mapConductionType.put(2, "LBBB               ");
		mapConductionType.put(3, "RBBB + LAFB        ");
		mapConductionType.put(4, "RBBB (without LAFB)");
		mapConductionType.put(5, "LAFB               ");
		mapConductionType.put(6, "LVH                ");
